...
class StressTest implements ExceptionsReporter {
    ...
    String[] names = {
            "Thomas Shelby", "Liam de Villers", "Olivia Shopkins", "Noah Cruz", "Emma Waters", "Oliver Trust",
            "Ava O'Brien", "William Williams", "Sophia Sofa", "Elijah Stern", "Isabella Brown", "James Scott",
            "Charlotte Dikes", "Benjamin Xavier", "Amelia Hopkins", "Lucas Thompson", "Mia Hamilton", "Mason Jar",
            "Harper Charlie", "Ethan Hunt", "Mariah Steels"
    };
    ...
    private void execute(int count) throws Exception {
        ...
        by = By.cssSelector("#fname");
        driver.findElement(by).sendKeys(names[count%20]);
        ...
        if(count!=99){
            by = By.xpath("//button[. = 'Search Flights']");
            driver.findElement(by).click();
        }
